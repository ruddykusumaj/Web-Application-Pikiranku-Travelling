        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Rekomendasi Penginapan<br> That Suits Your Needs</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
                ...
                <div class="col-lg-12 scrolling-wrapper">
                    ...
                    ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><?php echo $row['Nama_penginapan']; ?></h3>
                            ...
                            <div class="button-container">
                                <button class="btn-solid-reg popup-with-move-anim" onclick="window.location.href='Konten/penginapan_konten.php?id=<?= $row['penginapan_id'] ?>'">DETAILS</button>
