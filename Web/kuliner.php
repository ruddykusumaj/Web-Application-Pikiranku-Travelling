        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Rekomendasi Kuliner<br> That Suits Your Needs</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
                ...
                <div class="col-lg-12 scrolling-wrapper">
                    ...
                    ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><?php echo $row['Nama_kuliner']; ?></h3>
                            ...
                            <div class="button-container">
                                <button class="btn-solid-reg popup-with-move-anim" onclick="window.location.href='Konten/kuliner_konten.php?id=<?= $row['kuliner_id'] ?>'">DETAILS</button>
...
disusun dan dibuat oleh 5 mahasiswa Universitas Multimedia Nusantara angkatan 2019 jurusan sistem informasi yang sedang menempuh pendidikannya di kursi sarjana.
          ...
          <div class="col-md-2">
            <div class="text-container">
              ...
              <ul class="list-unstyled li-space-lg">
                <li>
                  <a class="white" href="#your-link">figma.com</a>
                </li>
              </ul>
            </div>
            <!-- end of text-container -->
          ...
          <div class="col-md-2">
            <div class="text-container">
              ...
              <ul class="list-unstyled li-space-lg">
                <li>
                  <a class="white" href="#your-link">elearning.umn.ac.id</a>
                </li>
              </ul>
            </div>
            <!-- end of text-container -->
