...
<body data-spy="scroll" data-target=".fixed-top">
  ...
  <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link page-scroll" href="#konten">DESKRIPSI</a>
        </li>
        <!-- Dropdown Menu -->
  ...
  <div class="container" style="margin-top: 80px;" id="konten">
    <div class="row">
      <div class="col-lg-7">
        <div>
          <!DOCTYPE html>
          ...
          <body>
            ...
            <div class="img-magnifier-container">
              <img id="myimage" src="../<?= $row['foto_wisata'] ?>" width="600" height="400">
            </div>

            <p>(Arahkan kursor ke gambar untuk memperbesar)</p>
...
<div class="col-lg-5">
  <div class="text-container" style="margin-top: 90px;">
...
<center>
<h2 style="margin-top: 50px;">PETA LOKASI</h2>
  <div style="width: 1113px; border:#000 solid 2px">

    <!--Google map-->
    <div id="map-container-google-1" class="z-depth-1-half map-container">
      <iframe width="1110" height="500" src=<?= $row['gmap'] ?> frameborder="0" style="border: 0" allowfullscreen></iframe>
    </div>
  </div>
</center>
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/Danau.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
        <div class="col-lg-4">
          ...
          <a class="btn-outline-reg mfp-close as-button" href="javascript://"
            >BACK</a
          >
        </div>
        <!-- end of col -->
    ...
    <div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/gunung n danau 2.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/gunung n pantai.jpg"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/monjali.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/pantai.jpg"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/gunung n danau.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/monumen.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
      <div class="row">
        ...
        <div class="col-lg-8">
          <img
            class="img-fluid"
            src="../../Foto Tempat Liburan/gunung.png"
            alt="alternative"
          />
        </div>
        <!-- end of col -->
