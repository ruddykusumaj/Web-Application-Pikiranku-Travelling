...
<h1 style="text-align: center;">Tambah Wisata</h1>

<form id="feedbackForm" data-toggle="validator" action="wisata_edit_proses.php" enctype="multipart/form-data" method="POST" style="width: 100%; resize:none; padding-right: 30px; padding-left:20px;" data-focus="false">
  ...
  <label class="label-control" for="cmessage" style="margin-left: 3px;">Nama Tempat</label>
      <textarea style="height:32px; width: 100%; resize:none; margin-bottom:2px; margin-top:5px;" class="form-control-textarea" name="tempat" id="cmessage" required><?= $row['Nama_wisata'] ?></textarea>
...
<tr>
    ...
    <td>
    <a href="wisata_edit.php?id=<?= $row['wisata_id'] ?>">Edit</a>
    </td>
    <td>
    <a href="delete_wisata.php?id=<?= $row['wisata_id'] ?>">Delete</a>
