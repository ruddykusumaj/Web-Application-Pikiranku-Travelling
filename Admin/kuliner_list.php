...
<div class="sidenav">
    ...
    <h1 style="text-align: center;">Tambah Kuliner</h1>

  <form id="feedbackForm" data-toggle="validator" action="kuliner_proses.php" enctype="multipart/form-data" method="POST" style="width: 100%; resize:none; padding-right: 30px; padding-left:20px;" data-focus="false">
    <div class="form-group" style="padding-right: 50px;">
    <label class="label-control" for="cmessage" style="margin-left: 3px;">Nama Kuliner</label>
        <textarea style="width: 100%; resize:none; margin-top:5px;" class="form-control-textarea" name="kuliner" id="cmessage" required></textarea>
